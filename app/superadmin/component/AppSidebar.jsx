...
const navItems = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { name: "Active C&F Registration", path: "/superadmin/C&F/activeregistration", pro: false },
...

    {
        ...
        name: "C&F Withdrawal",
        subItems: [
            { name: "Pending", path: "/superadmin/C&F-Withdrawal/pending", pro: false },
            { name: "Success", path: "/superadmin/C&F-Withdrawal/success", pro: false },
            { name: "Invalid", path: "/superadmin/C&F-Withdrawal/invalid", pro: false },
        ],
    },
