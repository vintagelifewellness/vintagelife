...
import OrderDetails from "@/components/OrderDetails/Recycleorder";
...
export default function PendingOrders() {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            try {
                const response = await fetch(`/api/order/recycleorder/get/true`);
    ...
    return (
        <div className="max-w-7xl mx-auto lg:p-6 p-3 bg-white dark:bg-gray-700 shadow-lg rounded-lg text-gray-700 dark:text-white">
            <h2 className="text-2xl font-semibold mb-4 text-center">Deleted Order List</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6 items-end">
                ...
                <button
                    onClick={applyFilter}
                    className="bg-blue-500 h-min text-white px-4 py-2 rounded-lg hover:bg-blue-600 w-full"
                >
                    Show
                </button>
            </div>
