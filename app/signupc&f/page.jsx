...
export default function Signup() {
    ...
    const validateFields = () => {
        ...
        if (step === 3) {
            if (!formData.cfName.trim()) newErrors.cfName = "C&F Name is required";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("/api/c&f/create", completeFormData);
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 bg-gray-100">
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 animate-fade-in-up relative overflow-hidden">
                        ...
                        <div className="text-center mt-4">
                            ...
                            <button
                                onClick={() => {
                                    setShowModal(false);
                                    window.location.href = "/signinc&f";
                                }}
            ...
            <div className="bg-white p-6 rounded-xl shadow-2xl w-full max-w-2xl">
                <h2 className="text-2xl font-bold text-center text-[#161950] mb-4">
                    ...
                    {step !== 2 && (
                        <>
                            {step === 1 ? "Verify Email" : "Authorized C&F Partner Registration"}
                        </>
                        ...
                        <>
                            <div className="lg:col-span-2">
                                ...
                                <input
                                    ...
                                    required
                                />
                                {errors.cfName && <p className="text-red-500 text-xs mt-1">{errors.cfName}</p>}
                            </div>
                            <div className="lg:col-span-1">
